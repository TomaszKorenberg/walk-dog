...
const DashboardPage = () => {
    ...
    return (
        <>
            ...
            <div className={"dashboard-div"}>Witaj! Lorem Ipsum is simply dummy text of the printing and typesetting
                ...
                evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).Lorem
